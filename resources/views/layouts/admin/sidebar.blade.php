...
<aside class="min-w-64 border-r border-r-gray-300 overflow-y-auto select-none scrollbar-hide hidden md:block bg-white shadow">
    <div class="p-6">
        ...
        <nav class="space-y-2 text-sm">
            ...
            <a href="{{route('category.index')}}" class="flex items-center space-x-4 group text-gray-700 hover:bg-gray-100 rounded-md px-3 py-2">
                <span class="text-accent group-hover:opacity-100 opacity-70">
                    🗂️
                </span>
            ...
            <!-- Orders -->
            <div class="mt-4 mb-1 px-3 text-xs text-gray-400 uppercase">Payments</div>
            <a href="{{route('payment.index')}}" class="flex items-center space-x-4 group text-gray-700 hover:bg-gray-100 rounded-md px-3 py-2">
                <span class="text-accent group-hover:opacity-100 opacity-70">
                    📋
                </span>
