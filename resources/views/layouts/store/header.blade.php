<header class="flex flex-wrap items-center justify-between gap-4 w-full bg-black text-amber-400 shadow py-4 px-4 sm:px-8 md:px-12 lg:px-24 xl:px-72">
    <!-- Logo -->
    <h1 class="text-xl font-bold w-full sm:w-auto text-center sm:text-left">Gear Up Ecommerce</h1>
    ...
    <div class="flex items-center justify-end w-full sm:w-auto space-x-4">
        ...
        <!-- Cart -->
        <button class="flex items-center border rounded-xl px-3 py-2 text-sm space-x-2 hover:bg-neutral-800 transition">
            <span>CART / RS 0</span>
