    ...
    <div class="container mx-auto flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex items-center justify-end w-full sm:w-auto space-x-4 px-3 md:px-0 relative">
            ...
            <a href="{{route('store.cart')}}"
               class="flex items-center border rounded-xl px-3 py-2 text-sm space-x-2 hover:bg-neutral-800 transition cursor-pointer">
                <span>CART / RS 0</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="orange" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div class="flex hidden items-center bg-white border-2 h-10 justify-end w-[250px] px-3 md:px-0 absolute top-12" id="cart-modal">
